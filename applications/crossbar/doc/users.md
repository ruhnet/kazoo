...
`delay` | Delay (in seconds) before ringing the user's devices when part of a parallel bridge/originate | `integer()` |   | `false` |  
...
`timeout` | Default duration (in seconds) to ring the user's devices | `integer()` |   | `false` |  
